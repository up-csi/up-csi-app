...
export const members: mem[] = [
    ...
    { member_id: 65, name: 'Jovs Juanes', role: '', category: 'B&C', photo: 'JovsJuanes' },
    { member_id: 66, name: 'Karin Consebido', role: '', category: 'B&C', photo: 'KarinConsebido' },
    ...
    { member_id: 40, name: 'Ehren Castillo', role: '', category: 'Engg', photo: 'EhrenCastillo' },
    ...
    { member_id: 48, name: 'Mikel Arcardo', role: '', category: 'Engg', photo: 'MikelArcardo' },
    ...
    { member_id: 52, name: 'Cessa Gonzales', role: '', category: 'Exte', photo: 'CessaGonzales' },
    ...
    { member_id: 55, name: 'Diego Montenejo', role: '', category: 'Exte', photo: 'DiegoMontenejo' },
    ...
    { member_id: 31, name: 'Ethan Camingao', role: '', category: 'Innov', photo: 'EthanCamingao' },
    ...
    { member_id: 36, name: 'Sidney Fernando', role: '', category: 'Innov', photo: 'SidneyFernando' },
    ...
    { member_id: 16, name: 'Nate Zuñiga', role: '', category: 'M&I', photo: 'NateZuñiga' },
    ...
    { member_id: 24, name: 'Jus Ruaya', role: '', category: 'Service', photo: 'JusRuaya' },
